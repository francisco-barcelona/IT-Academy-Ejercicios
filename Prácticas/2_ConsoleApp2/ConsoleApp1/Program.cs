...
namespace ConsoleApp1
{
    class Program
    {
        ...
        static List<double> Exam { get; set; }
        ...
        static void Main(string[] args)
        {
            ...
            Dictionary<string, List<double>> exam = new Dictionary<string, List<double>>();
            Dictionary<string, List<double>> subject = new Dictionary<string, List<double>>();
        ...
        {
            CurrentOption = "n";
            Console.WriteLine("Menu de añadir notas. Añada notas y presione al enter");
